...
- 🩺 **Software Developer Intern @ [Floaid Medtech](https://floaid.com)** (IIT Madras Research Park-incubated cardiac-device startup) — hired as solo developer to build **Floex VR**, a Unity / Meta Quest 3 training simulator for the company's Floex 3.0 heart-lung machine, and presented it to investors.
...
**🌐 Client websites (live):** [floaid.com](https://floaid.com) — hand-coded site for Floaid Medtech with an interactive Canvas-based PVAD controller prototype · [nrityadhee.com](https://nrityadhee.com) — dependency-free site for a Kathak dance academy.

**📱 [Expense Tracker](https://github.com/55Pranjal/Expense-Tracker-Mobile-App)** — cross-platform **React Native** app for personal expense tracking.
